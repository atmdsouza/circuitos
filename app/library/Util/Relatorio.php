...
class Relatorio
{
    ...
    public function gerarPDFCircuito($id_circuito) {
        ...
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>Chamado</strong> <br/>{$circuito->chamado}";
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        ...
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>Tipo de Link</strong> <br/>{$circuito->Lov6->descricao}";
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        ...
        $corpo_html .= "<tr>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>SSID</strong> <br/>{$circuito->ssid}";
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>Banda</strong> <br/>{$circuito->Lov7->descricao}";
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>Rede Cliente</strong> <br/>{$circuito->ip_redelocal}";
        $corpo_html .= "</td>";
        $corpo_html .= "<td style='text-align: left; width: 25%;'>";
        $corpo_html .= "<strong>IP de Gerência</strong> <br/>{$circuito->ip_gerencia}";
        $corpo_html .= "</td>";
        $corpo_html .= "</tr>";
        $corpo_html .= "<tr>";
        $corpo_html .= "<td colspan='4' style='text-align: left; width: 100%;'>";

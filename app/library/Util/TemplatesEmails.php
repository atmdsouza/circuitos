...
class TemplatesEmails {
    ...
    public function recuperaSenha($dados){
        ...
        $html .= "<title>Recuperação de senha do sistema Circuitos - PRODEPA</title>";
        ...
        $html .= "<b>ATENÇÃO:</b> Você acaba de receber novas informações sobre seu acesso.";
        $html .= "</td>"; 
        $html .= "</tr>"; 
        $html .= "<tr style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;'>"; 
        ...
        $html .= "</tr>"; 
        $html .= "<tr style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;'>"; 
        $html .= "<td class='content-block' style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px; text-align: justify;' valign='top'>";
        ...
        $html .= "<tr style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;'>"; 
        $html .= "<td class='aligncenter content-block' style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; color: #999; text-align: center; margin: 0; padding: 0 0 20px;' align='center' valign='top'>";
        $html .= "Caso não tenha solicitado essa alteração, fale com nosso suporte!";
        $html .= "</td>"; 
        $html .= "</tr>"; 
        $html .= "</table>"; 
        $html .= "</div>"; 
    ...
    public function novoUsuario($dados){
        ...
        $html .= "<meta name='viewport' content='width=device-width'/>";
        $html .= "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8'/>";
        $html .= "<title>Bem vindo ao Sistema Circuitos - PRODEPA</title>";
        $html .= "<style type='text/css'>";
        $html .= "img {";
        $html .= "max-width: 100%;";
        $html .= "}";
        ...
        $html .= "<tr style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;'>"; 
        $html .= "<td class='aligncenter content-block' style='font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; color: #999; text-align: center; margin: 0; padding: 0 0 20px;' align='center' valign='top'>";
        $html .= "Bem vindo ao sistema Circuitos - PRODEPA";
        $html .= "</td>"; 
        $html .= "</tr>"; 
        $html .= "</table>"; 
        $html .= "</div>"; 

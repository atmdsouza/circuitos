...
var table = $("#tb_circuitos").DataTable({
    buttons: [
        ...
        {//Botão Anexo
            className: "bt_anexo",
            text: "Anexo",
            titleAttr: "Anexar Arquivos ao Circuito"
        },
...
table.on( "select deselect", function () {
    ...
    table.button( 5 ).enable( selectedRows === 1 );
});
...
function criarAnexo(id_circuitos)
{
    'use strict';
    $('#id_circuitos').val(id_circuitos);
    getIdentificador(id_circuitos);
...
function getIdentificador(id)
{
    ...
    $.ajax({
        ...
        dataType: "JSON",
        url: action,
        data: {metodo: 'visualizarCircuitosDesignacao', id: id},
        error: function (data) {
            if (data.status && data.status === 401) {
                swal({
                    title: "Erro de Permissão",
...
function montarTabelaAnexos(id_circuitos, visualizar)
{
    'use strict';
    var action = actionCorreta(window.location.href.toString(), "core/processarAjaxVisualizar");
    $.ajax({
...
function excluirAnexo(id_anexo)
{
    ...
    swal({
        ...
        $.ajax({
            ...
            dataType: "JSON",
            url: action,
            data: {metodo: 'excluirCircuitosAnexo', id: id_anexo},
            error: function (data) {
                if (data.status && data.status === 401) {
                    swal({
                        title: "Erro de Permissão",

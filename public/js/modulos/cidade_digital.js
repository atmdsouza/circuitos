...
function inicializar()
{
    ...
    autocompletarCidade('uf_estado','lid_cidade','id_cidade');
    autocompletarContrato('lid_contrato','i_id_contrato');
    autocompletarSetEquipamento('lid_set_equipamento','i_id_set_equipamento');
    autocompletarSetSeguranca('lid_set_seguranca','i_id_set_seguranca');
    autocompletarTerreno('lid_terreno','i_id_terreno');
    autocompletarTorre('lid_torre','i_id_torre');
    autocompletarUnidadeConsumidora('lid_unidade_consumidora','i_id_unidade_consumidora');
}
